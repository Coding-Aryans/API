...
public class DataProviderClass extends SetUp {

	/*@DataProvider(name="dp")
	public Object[][] getData(Method m) {
		String sheetName = m.getName();
		int rows = excel.getRowCount(sheetName);//5
	...
	public  Object[][] getData(Method m) {
		...
		System.out.println("SheetName-->"+configProperty.getTestSheetName());
		String sheetName=configProperty.getTestSheetName();
